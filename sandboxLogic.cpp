...
void Board::placeNumber(int x,int y, int size, struct data_domino dom){
    ...
    QString right, left;
    if (dom.left == 1)
        left = ":/extra/blockD1.png";
    else if(dom.left == 2)
        left = ":/extra/blockD2.png";
    else if(dom.left == 3)
        left = ":/extra/blockD3.png";
    else if(dom.left == 4)
        left = ":/extra/blockD4.png";
    else if(dom.left == 5)
        left = ":/extra/blockD5.png";
    else if(dom.left == 6)
        left = ":/extra/blockD6.png";
    else
        left = ":/extra/blockD0.png";

    if (dom.right == 1)
        right = ":/extra/blockD1.png";
    else if(dom.right == 2)
        right = ":/extra/blockD2.png";
    else if(dom.right == 3)
        right = ":/extra/blockD3.png";
    else if(dom.right == 4)
        right = ":/extra/blockD4.png";
    else if(dom.right == 5)
        right = ":/extra/blockD5.png";
    else if(dom.right == 6)
        right = ":/extra/blockD6.png";
    else
        right = ":/extra/blockD0.png";
...
void Board::showPlayerHand(int playerID)
{
    ...
    pieces->setPlainText(QString("Galaxy Destroyer has " + QString::number(playerOBJ[1].gotHand.size()) + " pieces left."));
    pieces->setPos(300,0);
    pieces->setDefaultTextColor(Qt::black);
    pieces->setFont(QFont("times", 20,75));
    game->scene->addItem(pieces);

    Button *robot=new Button(QPixmap(":/extra/catEnemy"));
    robot->setPos(200,200);
    game->scene->addItem(robot);

    QGraphicsTextItem *p = new QGraphicsTextItem;
    p->setPlainText(QString("Your opponent: Galaxy Destroyer"));
    p->setPos(290, 190);
